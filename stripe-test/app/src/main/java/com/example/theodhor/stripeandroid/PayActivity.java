...
public class PayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            stripe = new Stripe("[pk_test_4KUXuV4MKMN0nCyrwa2e2lQJ]");
    ...
    public void submitCard(View view) {
        ...
        */
        ...
        stripe.createToken(card, "[pk_test_4KUXuV4MKMN0nCyrwa2e2lQJ]", new TokenCallback() {
    ...
    public void postData(String description, String token,String amount) {
        ...
        try {
            URL url = new URL("[http://php7-test4app-ans.7e14.starter-us-west-2.openshiftapps.com/charge.php]");
